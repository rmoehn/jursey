...
(defn base-scenario []
  ...
  (ask "What is the outside volume of $q.0?")
  (ask "What is the inside volume of $q.1?")
  (unlock "sq.0.a")
...
(base-scenario)
(comment
  {"q" "Approx. how many $0 fit in a $1?",
   "sq" {"0" {"q" "What is the outside volume of $q.0?", "a" "185.193 cm³"},
         "1" {"q" "What is the inside volume of $q.1?", "a" :locked}},
   "r" {:max-v 6,
        "3" {"ws" {"q" "Approx. how many $0 fit in a $1?",
                   "sq" {"0" {"q" "What is the outside volume of $q.0?",
                              "a" "185.193 cm³"},
                         "1" {"q" "What is the inside volume of $q.1?",
                              "a" :locked}},
                   "r" :locked},
  ...
  {"q" "Approx. how many $0 fit in a $1?",
   ...
   "r" {:max-v 7,
        ...
        "3" {"ws" {"q" "Approx. how many $0 fit in a $1?",
             ...
             "children" {"0" {:max-v 1, "parent" :locked}, "1" :locked},
             "act" [:unlock "r"]},
        "6" {"ws" {"q" "Approx. how many $0 fit in a $1?",
                   "sq" {"0" {"q" "What is the outside volume of $q.0?",
                              "a" "185.193 cm³"},
                         "1" {"q" "What is the inside volume of $q.1?",
                              "a" :locked}},
   ...
   "r" {:max-v 8,
        "3" {"ws" {"q" "Approx. how many $0 fit in a $1?",
             ...
             "children" {"0" {:max-v 1,
                              ...
                              ;; ↓
                              "0" {"ws" {"q" "What is the outside volume of $0?",
                                         "sq" {},
                                         "r" :locked},
                                   "children" {},
                                   ...
                                   "act" [:unlock "q.0"]},
                              ;; ↓
                              "1" {"ws" {"q" "What is the outside volume of [0: Rubik's Cubes]?",
                                         "sq" {},
                                         "r" :locked},
                                   "children" {},
                                   ;;     ↓
   ...
   "r" {:max-v 8,
        "3" {"ws" {"q" "Approx. how many $0 fit in a $1?",
             ...
             "children" {"0" {:max-v 1,
                              ...
                              ;;               ↓
                              "parent" {:max-v 0,
                                        "0" {"ws" {"q" "Approx. how many $0 fit in a $1?",
                                                   "sq" {},
                                                   "r" :locked},
                                             "children" {},
                                             "act" [:ask
                                                    "What is the outside volume of $q.0?"]}}},
                         "1" :locked},
             "act" [:unlock "r"]}}})
...
(comment
  {"q" "Have a look at [0:
      ...
      ;; time when the hypertext was created.
       ...
       {“ws”
        ...
        ;; ‘launder’ it through a sub-question. See below.
         “sq”
         {“0” {“q” “What is the outside volume of $q.0?”, “a” :locked},
          “1” {“q” “What is the inside volume of $q.1?”, “a” :locked}},
         “r” :locked},
        “children” {“0” :locked, “1” :locked},
        “act” [:unlock “sq.0.a”]}}
   ...
   "sq" {},
   "r" :locked})
(ask "Give me $q.0.2.ws.q.0.")
(unlock "sq.0.a")
(reply "$q.0")
(unlock "sq.0.a.0")
(comment
  {…
   "sq" {"0" {"q" "Give me $q.0.2.ws.q.0.", "a" "[0: Rubik's Cubes]"}},
   "r" :locked})
